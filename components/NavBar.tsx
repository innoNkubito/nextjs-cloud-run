...
const NavBar = () => {
    return (
        <nav
            className="relative w-full flex flex-wrap items-center justify-between py-3 bg-gray-900 text-gray-200 shadow-lg navbar navbar-expand-lg navbar-light h-1/8"
        >
            <div className="container-fluid w-full flex flex-wrap items-center px-6">
                ...
                <div className="collapse navbar-collapse flex flex-row items-center" id="navbarSupportedContent1">
                    <a className="text-xl text-white pr-2 font-semibold" href="#">TMS</a>
                    {/* <!-- Left links --> */}
                    <ul className="navbar-nav flex flex-row pl-0 list-style-none mr-auto">
                        <li className="nav-item p-2">
                            <Link className="nav-link text-white" href="#">Greeting</Link>
                        </li>
                        <li className="nav-item p-2">
                            <a
